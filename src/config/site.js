...
const SITE_URL = import.meta.env.PUBLIC_SITE_URL || 'https://weblabstudio.de';

export const siteConfig = {
	title: "Web Lab Studio",
	author: "Stephen James Morris",
	url: SITE_URL,
	mail: "info@weblabstudio.de",
	utm: {
		source: `${SITE_URL}`,
		medium: "referral",
		campaign: "navigation",
	...
	meta:{
		title: "Web Lab Studio - Web Development",
	...
	// social links
	social:{
		twitter: "http://x.com/sjm.dev/",
		twitterName: "sjm.dev",
		github: "https://github.com/StephenJamesMorris",
		blog: "https://weblabstudio.de",
	},
};
...
export const socialLinks = [
	...
	{
		name: 'Github',
		url: 'https://github.com/StephenJamesMorris/',
